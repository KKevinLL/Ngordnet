...
public class YearlyRecordWeird {
    ...
    /**
     * Returns the number of words with fewer Zs than x, where x is some key in
     * the map. If x is not part of the map, return -1.
     */
    ...
    private void updateFewerZsCount() {
        ...
        /**
         * The slow approach: For every key, compare against all other keys, and
         * count zs. O(N^2) -- slow compared to sorting.
         */
        ...
        /*
         * This is specific to this weird problem I've made up, not the project.
         */
        int lastZCount = 0;
    ...
    public static void main(String[] args) {
        ...
        yr.put("zebras", 95);
        yr.put("zebraz", 105);
        System.out.println(yr.fewerZs("zzzzz")); // should be 3: peel, zebras,
                                                 // zebraz
